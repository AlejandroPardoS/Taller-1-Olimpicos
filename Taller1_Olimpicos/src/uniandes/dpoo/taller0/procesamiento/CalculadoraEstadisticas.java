...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Retorna el país del atleta
	 * 
	 * @param atleta El nombre del atleta que se está buscando
	 * @return El país con del atlets o null si no se encuentra el atleta.
	 */
	public String atletaPorPais(String atleta)
	{
		Atleta elAtleta = buscarAtleta(atleta);
		if (elAtleta != null)
		{
			Pais pais = elAtleta.darPais();
			String paisRepre = pais.darNombre();
			return paisRepre;
		}
		else
		{
