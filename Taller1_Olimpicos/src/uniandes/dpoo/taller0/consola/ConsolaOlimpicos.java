...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais de un atleta especifico");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra el usuario el pais del atletas que ingrese
	 */
	private void ejecutarPaisAtleta()
	{
		String nombreAtleta = input("Por favor ingrese el nombre del atleta");
		String pais = calculadora.atletaPorPais(nombreAtleta);
		if (pais != null)
		{
			System.out.println("El atleta " + nombreAtleta + " representa al pais " + pais);
		}
		else
		{
			System.out.println("El atleta " + nombreAtleta + " no existe");
		}
	}
